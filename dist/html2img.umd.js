(function (global, factory) {
	...
	(global = global || self, global.html2img = factory(global.html2canvas));
	...
	*/
	...
	function genBase64(src) {
	  return new promise$3(function (resolve, rejects) {
	    // 校验 src 是否正确
	    if (src.match(/base64/)) return resolve(src); // 创建 canvas

	    var canvas = document.createElement('canvas');
	    var ctx = canvas.getContext('2d');
	    var img = new Image(); // 将图片画到 canvas 上
	...
	function parseHtml(html) {
	  var imgList, task, urls;
	  return regenerator.async(function parseHtml$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          _context.prev = 0;
	          // 找出所有的 img
	          imgList = html.querySelectorAll('img'); // 生成对应 img 的 base64地址

	          task = from_1$2(imgList, function (item) {
	            return genBase64(item.src);
	          });
	          _context.next = 5;
	          return regenerator.awrap(promise$3.all(task));

	        case 5:
	          urls = _context.sent;

	          forEach$3(urls).call(urls, function (url, i) {
	            return imgList[i].src = url;
	          });
	        ...
	        case 9:
	          ...
	          console.error(_context.t0, '图片错误');
	...
	function html2img(html, options) {
	  var myCanvas, width, height, scale, canvas;
	  return regenerator.async(function html2img$(_context2) {
	    while (1) {
	      switch (_context2.prev = _context2.next) {
	        case 0:
	          ...
	          myCanvas.style.width = "".concat(width, "px");
	          myCanvas.style.height = "".concat(height, "px");
	          _context2.next = 11;
	          return regenerator.awrap(html2canvas(html, {
	            width: width,
	            height: height,
	            scale: scale,
	            useCORS: true,
	        ...
	        case 11:
	          ...
	          return _context2.abrupt("return", canvas.toDataURL('image/jpeg', 1));

	        case 15:
	          _context2.prev = 15;
	          _context2.t0 = _context2["catch"](0);
	          return _context2.abrupt("return", promise$3.resolve(_context2.t0));
	 ...
	 */
	var _callee = (function _callee(element, options) {
	  var _ref, _ref$debug, debug, _ref$scale, scale, _ref$base, base64, html, url;

	  return regenerator.async(function _callee$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          _ref = options || {}, _ref$debug = _ref.debug, debug = _ref$debug === void 0 ? false : _ref$debug, _ref$scale = _ref.scale, scale = _ref$scale === void 0 ? 2 : _ref$scale, _ref$base = _ref.base64, base64 = _ref$base === void 0 ? false : _ref$base;
	          ...
	          _context.next = 4;
	          return regenerator.awrap(parseHtml(element));
	        ...
	        case 8:
	          ...
	          return _context.abrupt("return", promise$3.resolve(''));

	        case 12:
	          _context.next = 14;
	          return regenerator.awrap(html2img(html, {
	            scale: scale
	          }));
